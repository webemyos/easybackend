...
var preston = function()
{
    ...
    this.execute = function(path)
    {
        ...
        var mController = new masterController();
            ...
            mController.view = "./apps/preston/site/view/master/master.html";
        ...
        if(path.length == 3)
        {
          ...
          var action = "index";
          var path = "./apps/preston/site/controller/indexController.js";
        }
        else
        {
            //Selected controller
            ...
            var path = "./apps/preston/site/controller/" + controllerName + "Controller.js";
        }
