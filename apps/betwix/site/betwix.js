...
var betwix = function()
{
    ...
    this.execute = function(path)
    {
        ...
        var mController = new masterController();
            ...
            mController.view = "./apps/betwix/site/view/master/master.html";
        ...
        if(path.length == 3)
        {
          ...
          var action = "index";
          var path = "./apps/betwix/site/controller/indexController.js";
        }
        else
        {
            //Selected controller
            ...
            var path = "./apps/betwix/site/controller/" + controllerName + "Controller.js";
        }
